...
const Register = () => {
    ...
    >
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-green-700 transition-all text-sm sm:text-base md:text-lg"
        />
      </div>
      ...
      <button
        type="submit"
        disabled={loading}
        className="bg-gradient-to-r from-green-800 to-green-400 text-white rounded-lg py-3 px-6 mt-4 flex justify-center items-center gap-2 hover:from-green-900 hover:to-green-500 transition-all transform hover:-translate-y-1 shadow-lg disabled:opacity-50 text-sm sm:text-base md:text-lg font-medium"
      >
        {loading ? (
          "Registering..."
        ) : (
  ...
  const renderAnimation = () => (
    <div className="absolute mt-10 top-0 left-0 w-full h-full z-0 flex justify-center items-center">
      <video
        ref={videoRef}
        src="/plant_gif.mp4"
        autoPlay
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-cover bg-center relative bg-[url('/Forest-Habitat.jpg')] px-4 py-6">
      ...
      {showAnimation && !videoEnded ? (
        ...
        <div className="bg-white/50 backdrop-blur-lg rounded-2xl p-4 sm:p-6 md:p-10 shadow-2xl w-full max-w-md mx-auto relative z-10 mt-40 transition-transform duration-300">
          ...
          <p className="text-center text-gray-700 mb-6 text-xs sm:text-sm md:text-base px-2">
